...
public class QCartItem extends EntityPathBase<CartItem> {
    ...
    private static final long serialVersionUID = -798779007L;
    ...
    public final com.group.shopping.domain.item.QItem item;
    ...
    public QCartItem(Class<? extends CartItem> type, PathMetadata metadata, PathInits inits) {
        ...
        this.item = inits.isInitialized("item") ? new com.group.shopping.domain.item.QItem(forProperty("item")) : null;
    }
